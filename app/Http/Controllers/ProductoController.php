...
class ProductoController extends Controller
{
     ...
     public function index(Request $request)
    {
        ...
        return view('productos.index')->with('marcas',$marcas)
                                      ->with('tipos',$tipos);
    }
    ...
    {                                     
        ...
        // $marca = Marca::updateOrCreate(['nombreM'=> $request['nombreM']]);
        // $tipo = Tipo::updateOrCreate(['nombreT'=> $request['nombreT']]);

        //insert en la tabla marca
        ...
        // $idMfk= marca()->idM;
        // Arr::only($info, ['nombre', 'unidades']);
        // $marcas = Marca::all();
        // $marca = Marca::only($marcas, ['idM']);

        // $producto->idMfk = $marca;
